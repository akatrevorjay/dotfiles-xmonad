...
{-[>myNormalFGColor :: Data.String.IsString <]                                                                                                                            -}
...
{-myStatusBar = "/home/trevorj/.bin/dzen2 -x '400' -y '0' -h '16' -w '900' -ta 'l' -fg '" ++ myNormalFGColor ++ "' -bg '" ++ myNormalBGColor ++ "' -fn '" ++ myFont ++ "'"-}
